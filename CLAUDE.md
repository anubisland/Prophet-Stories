...
## 11-ب. حجم الخريطة والشريط السفلي

الرأس الثابت كان يبتلع الشاشة فيصعب تتبّع السرد. قياسٌ فعلي على `ishaq-yaqub`:
الرأس ٥٧٪ من الشاشة على لابتوب عادي، و٧٥٪ عند تكبير ١٨٠٪، و٨٦٪ على الهاتف بالعرض —
حتى اختفى نصّ السرد تمامًا. والسبب أن `max-height:34vh` للخريطة تعني ٢٩٢ بكسل على
شاشة ٨٦٠، فتنمو بلا حدّ كلما طالت الشاشة.

- **الخريطة**: `max-height: min(20vh, 172px)` — نسبة وسقف مطلق معًا. `vh` وحدها لا تكفي.
- **تصغير تدريجي** عند `max-height` ٨٢٠ ثم ٦٤٠ ثم ٥٠٠ بكسل: خريطة أصغر، عنوان أنحف،
  وإخفاء الجملة الفرعية، وحشو أقل.
- **الشريط السفلي**: حشو `7px 12px`، أزرار `6px 12px` بخط ١٢، زر التشغيل `7px 17px`،
  ودوائر ١٩ بكسل بفجوة ٥. بهذا نزل من ٩٠ إلى ٧٥ بكسل، وثبت على الهاتف بلا التفاف
  الدوائر إلى سطرين.
- **المعيار المطلوب**: لا تقل مساحة السرد عن **٤٠٪** من الشاشة في أي مقاس، وأن يظهر
  أول سطر من `.narrative` دون تمرير. النتيجة بعد الإصلاح: ٤٩٪ لابتوب، ٤٦٪ عند تكبير
  ١٨٠٪، ٥٧٪ تابلت، ٥٣٪ موبايل، ٣٥٪ هاتف بالعرض.

## 11-ج. نِسَب الخريطة والشريط (الخريطة أولوية)

الخريطة هي المهمة والشريط ثانوي — لكن الشريط يجب أن يبقى **مقروءًا** لا أن يختفي.

- **الخريطة**: `max-height:clamp(175px, 38vh, 340px)` **مع**
  `max-width:calc(<نفس القيمة> * 2.7)`. القيد الثاني ضروري: رسم الخريطة نسبته
  ٧٠٠×٢٦٠ أي ٢٫٧ عرضًا، فتقييد الارتفاع وحده يُلجئ المتصفح إلى تصغير الرسم وترك
  فراغ ميت على الجانبين (قِيس ١٢٣٧ بكسل صندوقًا مقابل ٧٢١ رسمًا) فتبدو الخريطة أصغر
  مما هي. ومطابقة العرض للارتفاع تُلغي الفراغ تمامًا.
- **الشريط**: ٦٠ بكسل. والمفتاح `line-height:1.15` على `.ctrl` و`line-height:1`
  على `.dot` — لأن `body{line-height:1.85}` يُورَث إلى الأزرار فيجعل ارتفاع الزر
  ٣٣ بكسل وخطه ١١٫٥ فقط. تصغير الحشو والخط بلا معالجة ارتفاع السطر لا يفعل شيئًا،
  وقد ضاعت عليّ محاولتان بسبب ذلك. أبقِ خط الأزرار ١٢ بكسل حتى يُقرأ.
- **النسبة المطلوبة**: الخريطة لا تقل عن **ضعفَي** الشريط. المتحقَّق: ٥٫٤× لابتوب،
  ٤٫٦× تابلت، ٢٫٩× عند تكبير ١٥٠٪، ٢٫٠× موبايل.
- **قيد لا حيلة فيه**: على هاتف عرضه ٣٧٥ تكون حاوية الخريطة ٣٣٢ بكسل، فارتفاع الرسم
  لا يتجاوز ١٢٣ بكسل مهما رُفع حدّ الارتفاع — لأن العرض هو القيد لا الارتفاع.
  تكبيرها هناك يحتاج إعادة رسم الخرائط بنسبة أقل عرضًا.

**تحذير للوكلاء**: لا تُدرج `@media` قبل القاعدة الأساسية — `@media` لا تزيد
الأولوية، فتفوز القاعدة الأخيرة ترتيبًا ويُلغى الاستعلام بصمت. وعند نزع كتلة CSS
بتعبير نمطي، تحقّق من توازن الأقواس في `<style>` **و**`<script>` بعدها؛ نزعٌ متسرّع
أتلف سكربت الصفحات الثماني هنا واستدعى الرجوع إلى آخر حفظة.
